module.exports = function (actionable, game, params, notify=true) {
  ...
  var actions = game.actions.findAll(x => x.to === actionable.to && x.tags.includes("roleblockable") && !x.tags.includes("permanent") && x.execution <= 0);
  ...
  game.actions.delete(x => x.to === actionable.to && x.tags.includes("roleblockable") && !x.tags.includes("permanent") && x.execution <= 0);
