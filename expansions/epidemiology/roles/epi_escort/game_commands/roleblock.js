...
module.exports = function (game, message, params) {
  ...
  if (from.misc.visit_log.includes(to.identifier)) {
    message.channel.send(":wine_glass: You have visited that player before. A random player will be chosen and roleblocked instead unless you resubmit your action.");
