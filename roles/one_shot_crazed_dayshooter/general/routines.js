...
module.exports = function (player) {
  ...
  if (player.misc.crazed_dayshooter_bullets > 0) {

    player.game.sendPeriodPin(channel, ":gun: You may choose to shoot a player today.\n\nYou currently have __" + player.misc.crazed_dayshooter_bullets + "__ bullet" + auxils.vocab("s", player.misc.crazed_dayshooter_bullets) + ".\n\nUse `" + config["command-prefix"] + "shoot <alphabet/name/nobody>` to select your target.\n\nThis action is irreversible.");
